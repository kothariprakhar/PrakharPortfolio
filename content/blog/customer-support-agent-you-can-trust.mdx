...
So I spent a few weekends building one anyway. The setup is a fictional company called MediaVault, a regional video rental chain whose operational data lives in the [Sakila sample database](https://dev.mysql.com/doc/sakila/en/).<Sidenote>Sakila is the canonical sample schema MySQL ships for its tutorials · sixteen tables, real foreign keys, deliberately messy customer data. The exact shape of a small operations DB without the legal exposure of a real one.</Sidenote> They get a steady stream of customer support emails (billing questions, late fee disputes, account changes, occasional rage). The job of the agent is to read each email, decide what to do, and either draft a reply or escalate to a human.
...
<svg viewBox="0 0 700 360" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', background: '#F2EEE5', borderRadius: '2px', border: '1px solid rgba(160, 82, 45, 0.12)', margin: '24px 0' }}>
  <defs>
    <marker id="arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto-start-reverse">
      <path d="M 0 0 L 10 5 L 0 10 z" fill="#A0522D" />
    </marker>
  </defs>
  <rect x="40" y="30" width="160" height="60" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="120" y="56" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="600" fill="#14110D">User message</text>
  <text x="120" y="74" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">"Why is my bill $5 higher?"</text>
  <line x1="200" y1="60" x2="265" y2="60" stroke="#A0522D" strokeWidth="1.5" markerEnd="url(#arrow)" />
  <rect x="265" y="30" width="170" height="60" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="350" y="56" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="600" fill="#14110D">LLM call</text>
  <text x="350" y="74" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">with tool schemas</text>
  <line x1="435" y1="60" x2="495" y2="60" stroke="#A0522D" strokeWidth="1.5" markerEnd="url(#arrow)" />
  <polygon points="495,30 660,30 660,90 495,90 470,60" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="575" y="56" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="600" fill="#14110D">Tool call?</text>
  <text x="575" y="74" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">(yes / no)</text>
  ...
  <rect x="475" y="160" width="200" height="60" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="575" y="186" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="600" fill="#14110D">Execute tool</text>
  <text x="575" y="204" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">SQL, lookup, draft, etc.</text>
  <path d="M 475 190 Q 350 190 350 90" stroke="#A0522D" strokeWidth="1.5" fill="none" markerEnd="url(#arrow)" />
  <text x="350" y="155" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">Append result, loop</text>
  ...
  <rect x="265" y="220" width="170" height="60" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="350" y="246" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="600" fill="#14110D">Final response</text>
  <text x="350" y="264" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">return to user</text>
  <text x="350" y="320" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#6F6A5E" fontStyle="italic">The agent loops between thinking (LLM) and acting (tools) until it has nothing left to do.</text>
</svg>
...
<svg viewBox="0 0 720 380" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', background: '#F2EEE5', borderRadius: '2px', border: '1px solid rgba(160, 82, 45, 0.12)', margin: '24px 0' }}>
  <ellipse cx="360" cy="190" rx="100" ry="60" fill="#F6F2E9" stroke="#A0522D" strokeWidth="2" />
  <text x="360" y="184" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="14" fontWeight="700" fill="#14110D">LLM Agent</text>
  <text x="360" y="202" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">orchestration loop</text>
  <rect x="30" y="30" width="160" height="50" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="110" y="50" textAnchor="middle" fontFamily="ui-monospace" fontSize="11" fill="#14110D">get_current_date()</text>
  <text x="110" y="66" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#6F6A5E">today's date</text>
  <line x1="190" y1="55" x2="280" y2="160" stroke="#A0522D" strokeWidth="1" strokeOpacity="0.5" />
  <rect x="30" y="100" width="160" height="50" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="110" y="120" textAnchor="middle" fontFamily="ui-monospace" fontSize="11" fill="#14110D">get_db_schema()</text>
  <text x="110" y="136" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#6F6A5E">table + column listing</text>
  <line x1="190" y1="125" x2="280" y2="170" stroke="#A0522D" strokeWidth="1" strokeOpacity="0.5" />
  <rect x="30" y="170" width="160" height="50" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="110" y="190" textAnchor="middle" fontFamily="ui-monospace" fontSize="11" fill="#14110D">run_sql_query(q)</text>
  <text x="110" y="206" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#6F6A5E">SELECT only, LIMIT 100</text>
  <line x1="190" y1="195" x2="280" y2="195" stroke="#A0522D" strokeWidth="1" strokeOpacity="0.5" />
  <rect x="30" y="240" width="160" height="50" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="110" y="260" textAnchor="middle" fontFamily="ui-monospace" fontSize="11" fill="#14110D">get_policy_context</text>
  <text x="110" y="276" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#6F6A5E">retrieve from policy.md</text>
  <line x1="190" y1="265" x2="280" y2="220" stroke="#A0522D" strokeWidth="1" strokeOpacity="0.5" />
  <rect x="530" y="100" width="160" height="50" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="610" y="120" textAnchor="middle" fontFamily="ui-monospace" fontSize="11" fill="#14110D">draft_customer_email</text>
  <text x="610" y="136" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#6F6A5E">templated, validated reply</text>
  <line x1="530" y1="125" x2="440" y2="170" stroke="#A0522D" strokeWidth="1" strokeOpacity="0.5" />
  <rect x="530" y="170" width="160" height="50" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="610" y="190" textAnchor="middle" fontFamily="ui-monospace" fontSize="11" fill="#14110D">create_escalation_ticket</text>
  <text x="610" y="206" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#6F6A5E">structured human handoff</text>
  ...
  <text x="360" y="332" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="600" fill="#14110D">Approval Gate intercepts every tool call</text>
  <line x1="360" y1="250" x2="360" y2="310" stroke="#A0522D" strokeWidth="1.5" strokeDasharray="3 3" />
  <text x="375" y="285" fontFamily="ui-sans-serif" fontSize="10" fill="#6F6A5E" fontStyle="italic">all calls</text>
  <text x="110" y="20" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#6F6A5E" fontStyle="italic">Reading tools (left)</text>
  <text x="610" y="80" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#6F6A5E" fontStyle="italic">Acting tools (right)</text>
</svg>
...
<svg viewBox="0 0 720 360" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', background: '#F2EEE5', borderRadius: '2px', border: '1px solid rgba(160, 82, 45, 0.12)', margin: '24px 0' }}>
  <defs>
    <marker id="arrow2" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto-start-reverse">
      <path d="M 0 0 L 10 5 L 0 10 z" fill="#A0522D" />
    </marker>
  </defs>
  <rect x="280" y="20" width="160" height="50" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="2" />
  <text x="360" y="42" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="700" fill="#14110D">Tool call</text>
  <text x="360" y="60" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">requested by LLM</text>
  <line x1="360" y1="70" x2="360" y2="100" stroke="#A0522D" strokeWidth="1.5" markerEnd="url(#arrow2)" />
  <polygon points="280,100 440,100 440,160 280,160" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="360" y="125" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="600" fill="#14110D">Approval Gate</text>
  <text x="360" y="145" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">runs all 3 checks</text>
  ...
  <text x="360" y="178" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="9" fill="#6F6A5E">checks each tool call against:</text>
  <rect x="20" y="220" width="200" height="80" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="120" y="244" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="600" fill="#14110D">1. SQL safety</text>
  <text x="120" y="262" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">no UPDATE/DELETE/DROP</text>
  <text x="120" y="276" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">no bulk PII queries</text>
  <text x="120" y="290" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">PII must filter by ID</text>
  <rect x="260" y="220" width="200" height="80" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="360" y="244" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="600" fill="#14110D">2. Draft hygiene</text>
  <text x="360" y="262" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">no "confidential"</text>
  <text x="360" y="276" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">no "internal use only"</text>
  <text x="360" y="290" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">in customer findings</text>
  <rect x="500" y="220" width="200" height="80" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="600" y="244" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="600" fill="#14110D">3. Forced escalation</text>
  <text x="600" y="262" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">high-risk keywords</text>
  <text x="600" y="276" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">block drafting,</text>
  <text x="600" y="290" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">force escalate path</text>
  <text x="360" y="335" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#6F6A5E" fontStyle="italic">Any failed check returns a refusal with a reason. The LLM sees it and adapts.</text>
</svg>
...
The single biggest critique of this design, which I will get to in the stakeholder section, is that all three of these checks live in Python code.<Sidenote>The IT Lead persona caught this in the first minute of the simulated review. A regex blocking `DROP TABLE` is not a firewall · it is a hint to the model.</Sidenote> A more defensible architecture would push some of them down into the infrastructure: a database user with `GRANT SELECT` only at the Postgres level, statement timeouts to prevent expensive queries, an audit log piped into a SIEM. The Python gate is one layer in a defense-in-depth strategy. It should not be the only layer.
...
<svg viewBox="0 0 720 460" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', background: '#F2EEE5', borderRadius: '2px', border: '1px solid rgba(160, 82, 45, 0.12)', margin: '24px 0' }}>
  <defs>
  ...
  <rect x="280" y="20" width="160" height="50" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="2" />
  <text x="360" y="42" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="13" fontWeight="700" fill="#14110D">New email</text>
  <text x="360" y="60" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">arrives in support queue</text>
  <line x1="360" y1="70" x2="360" y2="95" stroke="#A0522D" strokeWidth="1.5" markerEnd="url(#arrow3)" />
  <rect x="240" y="95" width="240" height="50" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="360" y="118" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="600" fill="#14110D">Stage 1: Safety check</text>
  <text x="360" y="135" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">scan for legal/safety keywords</text>
  ...
  <rect x="260" y="200" width="200" height="50" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="360" y="223" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="600" fill="#14110D">Stage 2: Investigate</text>
  <text x="360" y="240" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">DB lookup + policy retrieval</text>
  <line x1="360" y1="250" x2="360" y2="295" stroke="#A0522D" strokeWidth="1.5" markerEnd="url(#arrow3)" />
  <polygon points="260,295 460,295 460,335 260,335 240,315" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="360" y="320" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="600" fill="#14110D">Stage 3: Decide path</text>
  ...
  <text x="120" y="223" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="700" fill="#14110D">Path A: Red Alert</text>
  <text x="120" y="240" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">escalate, no draft</text>
  <line x1="120" y1="250" x2="120" y2="380" stroke="#A0522D" strokeWidth="1" strokeOpacity="0.5" />
  <rect x="20" y="380" width="200" height="60" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="120" y="404" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fontWeight="600" fill="#14110D">create_escalation_ticket</text>
  <text x="120" y="420" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">routed to Tier 2 queue,</text>
  <text x="120" y="432" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">no customer reply sent</text>
  <rect x="260" y="380" width="200" height="60" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="360" y="402" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fontWeight="600" fill="#14110D">Path B: Happy Path</text>
  <text x="360" y="418" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">draft_customer_email</text>
  <text x="360" y="432" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">routine info request</text>
  <rect x="500" y="380" width="200" height="60" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="600" y="402" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="11" fontWeight="600" fill="#14110D">Path C: Policy Dispute</text>
  <text x="600" y="418" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">draft if policy strict,</text>
  <text x="600" y="432" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">escalate if discretion</text>
</svg>
...
<svg viewBox="0 0 720 480" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', background: '#F2EEE5', borderRadius: '2px', border: '1px solid rgba(160, 82, 45, 0.12)', margin: '24px 0' }}>
  <defs>
    <marker id="arrow4" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto-start-reverse">
      <path d="M 0 0 L 10 5 L 0 10 z" fill="#A0522D" />
    </marker>
  </defs>
  <rect x="20" y="20" width="680" height="50" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" />
  <text x="40" y="44" textAnchor="start" fontFamily="ui-monospace" fontSize="11" fontWeight="600" fill="#14110D">EMAIL #1</text>
  <text x="40" y="60" textAnchor="start" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24">"FINAL CHANCE - Unacceptable Service & DEMANDS"  ·  body mentions "lawyer" and "sue"</text>
  <line x1="120" y1="70" x2="120" y2="100" stroke="#A0522D" strokeWidth="1.2" markerEnd="url(#arrow4)" />
  <rect x="20" y="100" width="200" height="44" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="40" y="120" textAnchor="start" fontFamily="ui-monospace" fontSize="11" fontWeight="600" fill="#A0522D">Iter 1</text>
  <text x="40" y="135" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">get_policy_context("legal threat")</text>
  ...
  <rect x="20" y="170" width="220" height="44" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="40" y="190" textAnchor="start" fontFamily="ui-monospace" fontSize="11" fontWeight="600" fill="#A0522D">Iter 2</text>
  <text x="40" y="205" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">run_sql_query (customer history)</text>
  ...
  <rect x="20" y="240" width="220" height="44" rx="6" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1" />
  <text x="40" y="260" textAnchor="start" fontFamily="ui-monospace" fontSize="11" fontWeight="600" fill="#A0522D">Iter 3a</text>
  <text x="40" y="275" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">run_sql_query (rental check)</text>
  ...
  <text x="40" y="345" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">draft_customer_email(...)</text>
  ...
  <text x="40" y="431" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">create_escalation_ticket(...)</text>
  ...
  <rect x="380" y="100" width="320" height="280" rx="8" fill="#F6F2E9" stroke="#A0522D" strokeWidth="1.5" strokeDasharray="4 2" />
  <text x="540" y="130" textAnchor="middle" fontFamily="ui-sans-serif" fontSize="12" fontWeight="700" fill="#14110D">What the agent learned</text>
  <text x="395" y="160" textAnchor="start" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24" fontWeight="600">Iter 1 · Policy</text>
  <text x="395" y="178" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">"Legal threats must be escalated</text>
  <text x="395" y="192" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">to Tier 2; no direct reply."</text>
  <text x="395" y="218" textAnchor="start" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24" fontWeight="600">Iter 2 · Customer history</text>
  <text x="395" y="236" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">"Active customer, 14 prior rentals,</text>
  <text x="395" y="250" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">3 prior late returns, no disputes."</text>
  <text x="395" y="276" textAnchor="start" fontFamily="ui-sans-serif" fontSize="11" fill="#2E2A24" fontWeight="600">Iter 3a · Rental specifics</text>
  <text x="395" y="294" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">"Latest rental returned 8 days late;</text>
  <text x="395" y="308" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">$8 fee accrued per policy."</text>
  ...
  <text x="395" y="352" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">Agent had factual answer in hand</text>
  <text x="395" y="366" textAnchor="start" fontFamily="ui-sans-serif" fontSize="10" fill="#2E2A24">but tried to send it directly.</text>
</svg>
